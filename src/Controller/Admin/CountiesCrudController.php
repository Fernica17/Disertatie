...
class CountiesCrudController extends AbstractCrudController
{
    ...
    {
        return $filters
            ->add(TextFilter::new('name', $this->translator->trans('counties.field.name', [], 'admin')))
            ->add(BooleanFilter::new('isActive', $this->translator->trans('counties.field.is_active', [], 'admin')));
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setEntityLabelInSingular($this->translator->trans('counties.entity.singular', [], 'admin'))
            ->setEntityLabelInPlural($this->translator->trans('counties.entity.plural', [], 'admin'))
            ->showEntityActionsInlined()
            ->setPageTitle('index', $this->translator->trans('counties.page.index', [], 'admin'))
            ->setPageTitle('new', $this->translator->trans('counties.page.new', [], 'admin'))
            ->setPageTitle('edit', fn (Counties $county) => $this->translator->trans('counties.page.edit', ['{name}' => $county->getName()], 'admin'))
            ->setPageTitle('detail', fn (Counties $county) => $county->getName());
    }
    ...
    {
        yield TextField::new('name', $this->translator->trans('counties.field.name', [], 'admin'));
        yield AssociationField::new('country', $this->translator->trans('counties.field.country', [], 'admin'));
        yield BooleanField::new('isActive', $this->translator->trans('counties.field.is_active', [], 'admin'))
    ...
    private function configureDetailFields(): iterable
    {
        ...
        yield TextField::new('name', $this->translator->trans('counties.field.name', [], 'admin'));
        yield AssociationField::new('country', $this->translator->trans('counties.field.country', [], 'admin'));
        yield ChoiceField::new('isActive', $this->translator->trans('counties.field.is_active', [], 'admin'))
            ->setChoices([
    ...
    public function createIndexQueryBuilder($searchDto, $entityDto, $fields, $filters): QueryBuilder
    {
        ...
        $qb->leftJoin('entity.country', 'cty')->addSelect('cty');
    ...
    public function persistEntity(EntityManagerInterface $entityManager, mixed $entityInstance): void
    {
        ...
        $this->addFlash('success', $this->translator->trans('counties.flash.created', [], 'admin'));
    }
    ...
    public function updateEntity(EntityManagerInterface $entityManager, mixed $entityInstance): void
    {
        ...
        $this->addFlash('success', $this->translator->trans('counties.flash.updated', [], 'admin'));
    }
}
