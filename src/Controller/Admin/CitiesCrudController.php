...
class CitiesCrudController extends AbstractCrudController
{
    ...
    {
        return $filters
            ->add(TextFilter::new('name', $this->translator->trans('cities.field.name', [], 'admin')))
            ->add(BooleanFilter::new('isActive', $this->translator->trans('cities.field.is_active', [], 'admin')));
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setEntityLabelInSingular($this->translator->trans('cities.entity.singular', [], 'admin'))
            ->setEntityLabelInPlural($this->translator->trans('cities.entity.plural', [], 'admin'))
            ->showEntityActionsInlined()
            ->setPageTitle('index', $this->translator->trans('cities.page.index', [], 'admin'))
            ->setPageTitle('new', $this->translator->trans('cities.page.new', [], 'admin'))
            ->setPageTitle('edit', fn (Cities $city) => $this->translator->trans('cities.page.edit', ['{name}' => $city->getName()], 'admin'))
            ->setPageTitle('detail', fn (Cities $city) => $city->getName());
    }
    ...
    {
        yield TextField::new('name', $this->translator->trans('cities.field.name', [], 'admin'));
        yield AssociationField::new('county', $this->translator->trans('cities.field.county', [], 'admin'));
        yield BooleanField::new('isActive', $this->translator->trans('cities.field.is_active', [], 'admin'))
    ...
    private function configureDetailFields(): iterable
    {
        ...
        yield TextField::new('name', $this->translator->trans('cities.field.name', [], 'admin'));
        yield AssociationField::new('county', $this->translator->trans('cities.field.county', [], 'admin'));
        yield ChoiceField::new('isActive', $this->translator->trans('cities.field.is_active', [], 'admin'))
            ->setChoices([
    ...
    public function createIndexQueryBuilder($searchDto, $entityDto, $fields, $filters): QueryBuilder
    {
        ...
        $qb->leftJoin('entity.county', 'co')->addSelect('co');
    ...
    public function persistEntity(EntityManagerInterface $entityManager, mixed $entityInstance): void
    {
        ...
        $this->addFlash('success', $this->translator->trans('cities.flash.created', [], 'admin'));
    }
    ...
    public function updateEntity(EntityManagerInterface $entityManager, mixed $entityInstance): void
    {
        ...
        $this->addFlash('success', $this->translator->trans('cities.flash.updated', [], 'admin'));
    }
}
